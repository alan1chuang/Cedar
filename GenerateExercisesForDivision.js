function GenerateExercisesForDivision(mathExerciseCreateRequest) {
    var questions = [];
    ...
    {     
        ...
        {
            validQuestion = true;
            question = GenerateAQuestionForDivision();
            ...
            if(question.answer.toString().length > mathExerciseCreateRequest.numberOfDigitsForAnswer)
            {
                validQuestion = false;
            }    
    ...
    function GenerateAQuestionForDivision() {
        var x = 0;
        var y = 0;
...
exports.GenerateExercisesForDivision = GenerateExercisesForDivision;
